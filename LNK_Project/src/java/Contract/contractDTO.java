...
public class contractDTO {
    ...
    public contractDTO(int contractID, String infoTitle, String bookingDate, String checkInDate, String checkOutDate, String contractStatus) {
        this.contractID = contractID;
        this.bookingDate = bookingDate;
        this.checkInDate = checkInDate;
        this.checkOutDate = checkOutDate;
    ...
    public contractDTO(int contractID, String infoTitle, String bookingDate, String checkInDate, String contractStatus) {
        this.contractID = contractID;
        this.bookingDate = bookingDate;
        this.checkInDate = checkInDate;
        this.contractStatus = contractStatus;
