...
public class infoDTO {
    ...
    public infoDTO(String lendID, int infoID, String couponID, String infoTitle, String infoAddress, String infoType, String infoTypeRoom, String infoNumber, float infoPrice, String inforImage, String infoDescription, String uploadDate, String infoStatus) {
        this.lendID = lendID;
        this.infoID = infoID;
    ...
    public infoDTO(String lendID, String couponID, String infoTitle, String infoAddress, String infoType, String infoTypeRoom, String infoNumber, float infoPrice, String inforImage, String infoDescription, String uploadDate, String infoStatus) {
        this.lendID = lendID;
        this.infoID = infoID;
        this.couponID = couponID;
        this.infoTitle = infoTitle;
    ...
    public infoDTO( String infoTitle, String inforImage,String infoType, String infoAddress, float infoPrice,Date upDate,String infoStatus  ) {
        this.infoTitle = infoTitle;
        this.infoAddress = infoAddress;
        this.infoType = infoType;
        this.infoPrice = infoPrice;
    ...
    public infoDTO(String infoTitle, String infoAddress, String infoType, float infoPrice, float couponDiscount) {
        this.infoTitle = infoTitle;
        this.infoAddress = infoAddress;
        this.infoType = infoType;
        this.infoPrice = infoPrice;
