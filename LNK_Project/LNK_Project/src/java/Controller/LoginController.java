...
//        
//        }  else if (userType != null && userType.equals("lendlord")) { // Lendlord  đăng nhập thành công, chuyển hướng đến trang profile của chủ nhà
//            if (lendDTO != null) {
//                request.getSession().setAttribute("user", lendDTO);
