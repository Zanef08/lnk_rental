        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                rows.forEach(function (row) {
                    ...
                    } else if (statusCell.textContent === "Pending" || statusCell.textContent === "Not Started" ) {
        ...
        <div id="Services" class="tabcontent">
            <div class="container">
                ...
                <div id="right">
                    ...
                    <p>Details services: <%= couponDetail.getCouponDetails()%></p>
                    <p>Apply for: <b><%= couponDetail.getCouponFor()%></b></p>
                    <p>Starting Date: <%= couponDetail.getStartDate()%></p>
                    <p>End Date: <%= couponDetail.getExpiredDate()%></p>
        ...
        <div id="News" class="tabcontent">
            <div class="container">
                ...
                <div id="right">
                    ...
                    <p>Author: <b><%= infoDetail.getLendID()%></b></p>
